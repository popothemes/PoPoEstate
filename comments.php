...
<div id="comments" class="comments-area">
    ...
    comment_form(
        array(
            ...
            'class_submit'      => 'submit',
            'name_submit'       => 'submit',
            'title_reply'       => __( 'Leave a comment', 'realtor' ),
            'title_reply_to'    => __( 'Leave a comment to %s', 'realtor' ),
            'cancel_reply_link' => __( 'Cancel comment', 'realtor' ),
            'label_submit'      => __( 'Post comment' , 'realtor' ),
            'format'            => 'xhtml',

            'comment_field' =>  '<p class="comment-form-comment"><textarea id="comment" class="form-control" placeholder="'.__('Your Comment', 'realtor').'" name="comment" rows="5" aria-required="true">' .
                '</textarea></p>',
