...
define("poporealestate_PRIMARY_COLOR", get_theme_mod("poporealestate_styles_primary_color", "#208873"));
define("poporealestate_SECONDARY_COLOR", get_theme_mod("poporealestate_default_secondary_color", "#1a1c28"));
...
if (!function_exists('poporealestate_enqueue_theme_scripts')) {
    ...
    function poporealestate_enqueue_theme_scripts()
    {
        if (!is_admin()) {
            ...
            {
                //Google Maps
                wp_enqueue_script('google-maps', "$protocol://maps.googleapis.com/maps/api/js?key=".get_theme_mod('poporealestate_google_maps_api_key')."&callback=initMap");
...
if (is_customize_preview()) {
    function poporealestate_embedded_css_output()
    {
        echo '<style id="poporealestate-dynamic-embedded-css">';
...
// Output custom CSS to live site
    add_action('wp_head', 'poporealestate_embedded_css_output');
}

//Get poporealestate Primary Color
function poporealestate_get_primary_color()
{
    return get_theme_mod("poporealestate_styles_primary_color", poporealestate_PRIMARY_COLOR);
}
function poporealestate_get_secondary_color()
{
    return get_theme_mod("poporealestate_styles_secondary_color", poporealestate_SECONDARY_COLOR);
}
