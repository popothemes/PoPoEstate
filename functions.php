            ...
            <div class="media-body">
                <div class="media-outer">
                    ...
                    <div class="comment-info">
                        <span><?php printf(__('Posted By: <a href="' . comment_author_url() . '">%s</a>', 'realtor'), sprintf('<cite class="fn">%s</cite>', get_comment_author_link())); ?></span>
...
function extra_user_profile_fields($user)
{
    ...
    <table class="form-table">
        ...
        <tr>
            <th><label for="instagram-url"><?php _e("Instagram URL"); ?></label></th>
            <td>
...
function realtor_search_suggestions()
{
    ...
    $keyword_post_query_found = false;
    ...
    if (empty($post_ids_with_meta_keywords)) {
        echo "empty";
        $regular_posts_args = array(
        ...
        $regular_posts_args = array(
            ...
            'tax_query' => $tax_query,
            'meta_query' => $meta_query,
            'post__in' => array_merge($post_ids_with_keywords, $post_ids_with_meta_keywords)
        );

    }

    $search_results=get_posts($regular_posts_args);
