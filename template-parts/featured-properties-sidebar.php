...
?>
    <div class="left-container">
                        ...
                        <div class="s-property">
                            <div class="row">
                                <div class="col-xs-5"><img
                                        src="<?php echo the_post_thumbnail_url('realtor_featured_property_thumbnail'); ?>"
                                        width="137" height="137" alt="" class="img-responsive"></div>

                                <div class="col-xs-7 s-property-detail">
                                    <h5><?php the_title(); ?></h5>
                                    <span class="price"><?php echo get_theme_mod('realtor_currency_prefix', $realtor_default_options['realtor_currency_prefix']) ?><?php echo get_post_meta(get_the_id(), 'price')[0]; ?></span>
                        ...
                        <div class="s-property">
                            <div class="row">
                                ...
                                <div class="col-xs-7 s-property-detail">
                                    <h5><?php the_title(); ?></h5>
                                    <span
                                        class="price"><?php echo get_theme_mod('realtor_currency_prefix', $realtor_default_options['realtor_currency_prefix']) ?><?php echo get_post_meta(get_the_id(), 'price')[0]; ?></span>
        ...
        <?php else: ?>
            ...
            <p><?php echo __('There are no featured properties.', 'realtor'); ?></p>

        <?php endif;
        ?>
        <a href="<?php echo get_theme_mod('realtor_listing_page', ''); ?>"
           class="property-link"><?php echo __('All Properties', 'realtor'); ?><i class="fa fa-caret-right"
