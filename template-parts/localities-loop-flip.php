<?php if ($the_query->have_posts()) : $flip_counter = 1;
    ...
    <?php while ($the_query->have_posts()): $the_query->the_post();
        ...
        if ($flip_counter == 3) {
            ?>
            <div class=" col-lg-4 col-sm-6 hidden-md-col mobile-locality locality-odd">
            ...
            <div class=" col-lg-4 col-sm-6 hidden-md-col mobile-locality locality-odd-flip">
                <div class="localities-box wow fadeInDown" data-wow-delay="100ms">
                    <div class="row">
        ...
        { ?>
            ...
            <div class=" col-lg-4 col-sm-6 hidden-localities locality-odd">
                <div class="localities-box wow fadeInDown" data-wow-delay="100ms">
                    <div class="row">
            ...
            <div class=" col-lg-4 col-sm-6 hidden-localities locality-odd-flip">
                <div class="localities-box wow fadeInDown" data-wow-delay="100ms">
                    <div class="row">
                        <div class="col-sm-6">
                            <?php echo $last_post['image']; ?>
        ...
        <div class=" col-lg-4 col-sm-6 locality-odd">
            <div class="localities-box wow fadeInDown" data-wow-delay="100ms">
                <div class="row">
                    <div class="col-sm-6">
                        <?php
        ...
        <div class=" col-lg-4 col-sm-6 locality-odd-flip">
            <div class="localities-box wow fadeInDown" data-wow-delay="100ms">
                <div class="row">
