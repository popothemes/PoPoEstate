<?php if($the_query->have_posts() ) : ?>
                ...
                <?php if(has_post_thumbnail()) { ?>
                        ...
                        ?>
                                          ...
                                          <p><?php the_excerpt(); ?></p>
                                          <a href="<?php the_permalink(); ?>" class="blog-read-more"><?php echo __('READ MORE', 'poporealestate'); ?><span class="screen-reader-text">of <?php the_title(); ?></span> <i class="ti-arrow-right"></i></a>
                                        </div>
                                        </div>
                                      </div>
